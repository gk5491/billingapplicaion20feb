    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          taxCategory: bill.taxCategory || "none",
          taxAmount: bill.taxAmount || 0,
          tcsType: bill.tcsType || "TCS",
          tcsCategory: bill.tcsCategory || "none",
          tcsValue: bill.tcsAmount || 0,
          tdsValue: bill.tdsAmount || 0,
